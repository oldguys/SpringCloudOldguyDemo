...
import com.example.oldguy.modules.workflow.dao.jpas.TransformEntityInfoMapper;
...
public class MultiWorkFLowService extends AbstractMultiWorkFLowService {
    ...
    public void covertToMultiInstance(String taskId, boolean sequential, Map<String, Object> data) {
        covertToMultiInstance(taskId, sequential, DefaultInstanceConvertToMultiInstance.ASSIGNEE_USER_EXP, data);
    }
